<?php
	...
	while($row = $query->fetch_assoc()){
		...
		$contents .= '
			<h2 align="center"><img src="../view/assets/images/logo_name.png" width="150" height="30"/></h2>
			<h4 align="center">'.$from_title." - ".$to_title.'</h4>
			<table cellspacing="0" cellpadding="3">  
    	       	<tr>  
            		<td width="25%" align="right">Employee Name: </td>
                 	<td width="25%"><b>'.$row['firstname']." ".$row['lastname']." ".$row['suffix'].'</b></td>
