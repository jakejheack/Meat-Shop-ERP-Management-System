<?php
	...
	if(isset($_POST['add'])){
		...
		$sql = "INSERT INTO customers_status (id, transno, cusid, cusname, cdate, amountin, amountout, branch, cpstat, xstat, notes, filetext, file, created_on) VALUES ('$id', '$transno','$cusid', '$cusname', '$cdate', '0', '$amountout', '$branch', 'Credit', '$xstat', '$notes', '$filetext', '$filename', NOW())";
		if($conn->query($sql)){
			session_start();
