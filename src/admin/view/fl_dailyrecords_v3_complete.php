                                    ...
                                    <table id="example" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SESSION['access'] == Administrator || $_SESSION['access'] == BranchControl || $_SESSION['branch'] == All){
                                                $users = "SELECT * FROM tb1_v3 WHERE f3='Complete';";
                                            } else {
                                                $users = "SELECT * FROM tb1_v3 WHERE f2='$branch' AND f3='Complete';";
                                            }
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while($row = $result->fetch_assoc())
                                                    { ?>
                                                        ...
                                                        <?php } ?>
                                                            <td style="width:5%;"><a href="dl_dr1_v3?path=../uploads/dailyRecords/<?php echo $row['imageText'];?>">DOWNLOAD</a></td>
