...
<?php if($_SESSION['newslet'] == on){?>
   ...
   <div id="layout-wrapper">
                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <?php if($_SESSION['addbut'] == on){?>
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li><a type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="mdi mdi-email-plus-outline mr-2"></i>&nbsp;&nbsp;Register </a></li>&ensp;
                                </ol>
                            </div>
                        <?php } ?>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table id="example" class="table table-bordered dt-responsive nowrap">
                                        ...
                                        <tbody>
                                            <?php
                                            $res = $MySQLiconn->query("SELECT * FROM webnewsletter ORDER BY created_on DESC");
    ...
    <?php include 'ex_newsletter_modal.php'; ?>
</div>
</div>
...
<script>
    ...
    function getRow(id){
      $.ajax({
        type: 'POST',
        url: '../controller/ex_newsletter_row.php',
        data: {id:id},
        dataType: 'json',
        success: function(response){
          $('.id').val(response.id);
          $('#edit_newsemail').val(response.newsemail);
          $('#del_newsemail').html(response.newsemail);
      }
  });
  }
</script>
