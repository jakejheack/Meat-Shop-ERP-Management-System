                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-2">&ensp;PK Out</h4>
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="dashboard1">&ensp;&nbsp;Home</a></li>
                                            <li class="breadcrumb-item active">Records</li>
                                            <li class="breadcrumb-item active">PK Out</li>
                                        </ol>
                                    </div>
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        &ensp;&ensp;
                                        <li><a href="fl_ovpk_in" class="btn btn-success waves-effect waves-light">&ensp;In&ensp;</a></li>&ensp;
                                        <li><a href="fl_ovpk_out" class="btn btn-danger waves-effect waves-light"> Out </a></li>&ensp;
                                    </ol>
                                        ...
                                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                             <?php
                                                $i = 1;
                                                $format = "M d Y";
                                                $res = $MySQLiconn->query("SELECT * FROM tb1 JOIN tbpk2 ON tbpk2.tb1_id=tb1.id WHERE pkout2 NOT IN (' ')");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo ucwords(strtolower($row['pkout1'])); ?></td>
                                                <td>₱ <?php echo number_format($row['pkout2'],2); ?></td>
                                            </tr>
                                            <?php
                                            } 
                                            ?>
                                            <?php
                                                $format = "M d Y";
                                                $res = $MySQLiconn->query("SELECT * FROM tb1 JOIN tbpk2 ON tbpk2.tb1_id=tb1.id WHERE pkout4 NOT IN (' ')");
                                                while($row=$res->fetch_array()){                                       
                                            ?>
                                            <tr>
                                                <td><?php echo $i; $i++;?></td>
                                                <td style="width:5%;"><?php echo date_format(date_create($row['f1']), $format); ?></td>
                                                <td><?php echo ucwords(strtolower($row['f2'])); ?></td>
                                                <td><?php echo ucwords(strtolower($row['pkout3'])); ?></td>
                                                <td>₱ <?php echo number_format($row['pkout4'],2); ?>
