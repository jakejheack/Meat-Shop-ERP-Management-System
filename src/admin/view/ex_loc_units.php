...
<?php include '../controller/ex_loc_units.php'; ?>
<!doctype html>
<html lang="en">
                   ...
                   <!-- start page title -->
                    ...
                    <div class="card card-body">
                        <div class="row" style="text-align:right">
                                ...
                                <div class="col-md-7">     
                                        <input type="text" name="ex_units" class="form-control" value="<?php if(isset($_GET['edit'])) echo $getROW['ex_units'];?>" placeholder="Add Units" autocomplete="off" required >
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="example" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                            <?php $res = $MySQLiconn->query("SELECT * FROM units");
                                                    while($row=$res->fetch_array()) { ?>
                                            <tr>
                                                <td><?php echo utf8_encode(ucwords(strtolower($row['ex_units']))); ?></td>
                                            ...
                                            <?php if($_SESSION['editbut'] == on || $_SESSION['deletebut'] == on){?>
                                                <td>
                                                    ...
                                                    <?php if($_SESSION['editbut'] == on){?>
                                                        <a href="?edit=<?php echo $row['ex_unitsID']; ?>" class="text-info" title="edit"><i class="mdi mdi-pencil-box-outline" style="font-size:17px"></i></a>
                                                    <?php } ?>
                                                    <?php if($_SESSION['deletebut'] == on){?>
                                                        <a href="?del=<?php echo $row['ex_unitsID']; ?>" onclick="return confirm('sure to delete !'); " class="text-dark ml-2" title="delete"><i class="mdi mdi-delete-variant" style="font-size:17px"></i></a>
                                                    <?php } ?>
                                                    </div>
                                                </td>
                                            <?php } ?>
