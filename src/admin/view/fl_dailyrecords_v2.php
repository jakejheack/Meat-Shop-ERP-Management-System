                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">v2.3</li>
                            </ol>
                        </div>
                                 ...
                                 <li>
                                    <div class="dropdown show">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item" href="fl_dailyrecords_v2_form_daet">Daet</a>
                                        <a class="dropdown-item" href="fl_dailyrecords_v2_form_magsaysay">Magsaysay</a>
                                        <a class="dropdown-item" href="fl_dailyrecords_v2_form_yashano">Yashano</a>
                                    </div>
                                </div>
                            </li>&ensp;
                        <?php } ?>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody style="zoom:90%">
                                        ...
                                        if($_SESSION['access'] == Administrator || $_SESSION['access'] == BranchControl) {
                                            $users = "SELECT * FROM tb1 WHERE f3 NOT IN('Ongoing','ReCheck') AND created_on = CURDATE() ORDER BY id DESC;";
                                        } elseif ($_SESSION['branch'] == Daet) {
                                            $users = "SELECT * FROM tb1 WHERE f2='Daet' AND  f3 NOT IN('Ongoing','ReCheck') AND created_on = CURDATE() ORDER BY id DESC;";
                                        } elseif ($_SESSION['branch'] == Manager) {
                                            $users = "SELECT * FROM tb1 WHERE f2='Manager' AND  f3 NOT IN('Ongoing','ReCheck') AND created_on = CURDATE() ORDER BY id DESC;";
                                        } elseif ($_SESSION['branch'] == Yashano) {
                                            $users = "SELECT * FROM tb1 WHERE f2='Yashano' AND  f3 NOT IN('Ongoing','ReCheck') AND created_on = CURDATE() ORDER BY id DESC;";
                                        }
                                ...
                                <?php }else{ ?>
                                    ...
                                    <tbody>
                                        ...
                                        if ($_SESSION['access'] == Administrator){
                                            $users = "SELECT * FROM tb1 WHERE f3 NOT IN('Complete');";

                                        } elseif ($_SESSION['access'] == BranchControl && $_SESSION['branch'] == All) {
                                            $users = "SELECT * FROM tb1 WHERE f3 NOT IN('Complete','Pending') AND created_on = CURDATE() OR f2='Daet' AND f3 NOT IN('Complete','Pending','Ongoing');";

                                        } elseif ($_SESSION['access'] == BranchControl) {
                                            $users = "SELECT * FROM tb1 WHERE f2 $_SESSION='access' AND f3 NOT IN('Complete','Pending') AND created_on = CURDATE() OR f2='Daet' AND f3 NOT IN('Complete','Pending','Ongoing');";

                                        } elseif ($_SESSION['branch'] == Daet) {
                                            $users = "SELECT * FROM tb1 WHERE f2='Daet' AND f3 NOT IN('Complete','Pending') AND created_on = CURDATE() OR f2='Daet' AND f3 NOT IN('Complete','Pending','Ongoing');";

                                        } elseif ($_SESSION['branch'] == Magsaysay) {
                                            $users = "SELECT * FROM tb1 WHERE f2='Magsaysay' AND f3 NOT IN('Complete','Pending') AND created_on = CURDATE() OR f2='Magsaysay' AND f3 NOT IN('Complete','Pending','Ongoing');";

                                        } elseif ($_SESSION['branch'] == Yashano) {
                                            $users = "SELECT * FROM tb1 WHERE f2='Yashano' AND f3 NOT IN('Complete','Pending') AND created_on = CURDATE() OR f2='Yashano' AND f3 NOT IN('Complete','Pending','Ongoing');";
                                        } else {
                                                            ...
                                                            <td style="text-align:right" id="btnPrint">
                                                              ...
                                                              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                  <?php if($_SESSION['viewbut'] == on){?>
                                                                    <a href="fl_dailyrecords_v2_form?view=<?php echo $row['id']; ?>" class="dropdown-item" title="view">View</a>
                                                                    <a href="fl_dailyrecords_v2_print?view=<?php echo $row['id']; ?>" class="dropdown-item" title="view">Print</a>
                                                                    <a href="dl_dr1?path=../uploads/dailyRecords/<?php echo $row['imageText'];?>" class="dropdown-item" title="view">Download</a>
                                                                <?php } ?>
                                                                <?php if($_SESSION['editbut'] == on){?>
                                                                    <a href="fl_dailyrecords_v2_form?rid=<?php echo $row['id']; ?>" class="dropdown-item" title="edit">Edit</a>
                                                                <?php } ?>
