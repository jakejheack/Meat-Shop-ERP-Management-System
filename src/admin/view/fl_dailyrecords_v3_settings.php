...
<?php include '../controller/fl_dailyrecords_v3_settings.php'; ?>
<!doctype html>
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-2">&ensp;Form Settings</h4>
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="dashboard1">&ensp;&nbsp;Home</a></li>
                                            <li class="breadcrumb-item active">Daily Records</li>
                                             <li class="breadcrumb-item active">Settings v3.0</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                       ...
                                       <div class="form-group row">
                                        ...
                                        <div class="form-group mb-0 text-right" style="position:relative; text-align: right;">
                                            <?php if(isset($_GET['edit'])){?>
                                                ...
                                                <a href="fl_dailyrecords_v3_form.php" class="btn btn-dark" style="color:white"><i class="mdi mdi-keyboard-backspace font-16 mr-1"></i> Back </a>
                                            <?php } else { ?>
                                                ...
                                                <a href="fl_dailyrecords_v3_form" class="btn btn-dark waves-effect waves-light" style="color:white"><i class="mdi mdi-keyboard-backspace mr-2"></i> Back </a>
                                            <?php } ?> 
                                        </div>
                                        <!-- End Button -->
                                    </div>
