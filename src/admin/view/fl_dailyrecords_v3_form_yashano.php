...
<?php if($_SESSION['records3'] == on){?>
	...
	<?php include '../controller/fl_dailyrecords_v3_submit.php'; ?>
	<?php
								...
								<?php if(isset($_GET['view'])) { ?>
									<div class="page-title-left">
										...
										<ol class="breadcrumb m-0">
											<li class="breadcrumb-item"><a href="dailyRecords_v3.php"> &ensp;&nbsp;Home</a></li>
											<li class="breadcrumb-item"><a href="dailyRecords_v3.php">Daily Records v3.0</a></li>
								...
								<?php } else { ?>
									...
									<?php if($_SESSION['access'] == Administrator){?>
										<div class="page-title-right">
											<a href="fl_dailyrecords_v3_settings?edit=1" style="font-size: 15px;" title="edit" class="btn btn-danger waves-effect waves-light mdi mdi mdi-progress-wrench"></a>&ensp;
										</div>
									<?php } ?>
								<?php } ?> 
							</div>
								...
								<div class="row">
									<div class="col-12" style="zoom:90%;">
										<div class="card">
											<div class="card-body">
												<div class="card-body">
													...
													<div class="card-body">
														<?php if ($setpktab1 == '1') { ?> 
															<?php include 'daily_files_v3/pk.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setpstab1 == '1') { ?> 
															<?php include 'daily_files_v3/ps.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setdisctab1 == '1') { ?> 
															<?php include 'daily_files_v3/disc.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setchicktab1 == '1') { ?> 
															<?php include 'daily_files_v3/chick_yashano.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setcuscredittab1 == '1') { ?> 
															<?php include 'daily_files_v3/cuscredit_yashano.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setempcredittab1 == '1') { ?> 
															<?php include 'daily_files_v3/empcredit_yashano.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setlehcredittab1 == '1') { ?> 
															<?php include 'daily_files_v3/lehcredit.php';?>
														<?php } else { ?>
														<?php } ?>  

														<?php if ($setcashremittab1 == '1') { ?> 
															<?php include 'daily_files_v3/cashremit.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setcashreturntab1 == '1') { ?> 
															<?php include 'daily_files_v3/cashreturn.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setbankdepotab1 == '1') { ?> 
															<?php include 'daily_files_v3/bankdepo.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setprifamilytab1 == '1') { ?> 
															<?php include 'daily_files_v3/prifamily.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setcrcardtab1 == '1') { ?> 
															<?php include 'daily_files_v3/crcard.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setdecardtab1 == '1') { ?> 
															<?php include 'daily_files_v3/decard.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setcheckstab1 == '1') { ?> 
															<?php include 'daily_files_v3/checks.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setcashiertab1 == '1') { ?> 
															<?php include 'daily_files_v3/cashier.php';?>
														<?php } else { ?>
														<?php } ?> 
													</div>
												</div> 
												...
												<?php include 'daily_files_v3/totalamount.php';?>



												<div class="row">

													<?php include 'daily_files_v3/scale.php';?>
													<?php include 'daily_files_v3/difference.php';?>
												...
												<div class="row">
													...
													<?php include 'daily_files_v3/sobra.php';?>
													<?php include 'daily_files_v3/totalsale.php';?>

												</div> 

												<div class="row">
													<?php include 'daily_files_v3/total.php';?>
												</div> 

												<br>
												<?php include 'daily_files_v3/upload.php';?>
												<?php include 'daily_files_v3/notes.php';?>


												<div class="row">
													<?php include 'daily_files_v3/cashierduty.php';?>
													<?php include 'daily_files_v3/recordduty.php';?>
												</div> 
											</div>
										</div>
										...
										<div class="form-group mt-3" style="position:relative; text-align: right;padding-right: 30px;">
											<?php if(isset($_GET['view'])){?>
												<a href="fl_dailyrecords_v3.php" id="btnPrint" class="btn btn-dark waves-effect waves-light" style="color:white"><i class="mdi mdi-keyboard-backspace mr-2"></i> Back </a>
											<?php }elseif(isset($_GET['rid'])) { ?> 
												...
												<a href="fl_dailyrecords_v3.php" class="btn btn-dark"><i class="mdi mdi-keyboard-backspace font-16 mr-1"></i> Back </a>
											<?php } else { ?>
												...
												<a href="fl_dailyrecords_v3.php" class="btn btn-dark waves-effect waves-light"><i class="mdi mdi-keyboard-backspace mr-2"></i> Back </a>
											<?php } ?> 
										</div>
										<div class="mt-4">
										</div>
