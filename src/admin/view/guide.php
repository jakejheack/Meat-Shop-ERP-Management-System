                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li><a href="#addnew" data-toggle="modal" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-account-multiple-plus-outline mr-2"></i> Add Employee </a></li>&ensp;
                                        </ol>
                                    </div>
