        ...
        if($_GET['rid'] !=""){
            ...
            if ($result_product->num_rows > 0) {
                ...
                if($_SESSION['branch'] == All) {
                    $res = $MySQLiconn->query("select eid as id,transno as tno,created_on as co,empname as ename,amountin as paid from employees_credit where transno not in (select epcreditin4 from tbepcredit1_v3) and not amountin='0' and branch='$rf2' and edate = CURDATE() and estat='Complete' order by edate desc;");
                }elseif($_SESSION['branch'] == Daet) {
                    $res = $MySQLiconn->query("select eid as id,transno as tno,created_on as co,empname as ename,amountin as paid from employees_credit where transno not in (select epcreditin4 from tbepcredit1_v3) and not amountin='0' and branch='Daet' and edate = CURDATE() and estat='Complete' order by edate desc;");
                    ...
                    $res = $MySQLiconn->query("select eid as id,transno as tno,created_on as co,empname as ename,amountin as paid from employees_credit where transno not in (select epcreditin4 from tbepcredit1_v3) and not amountin='0' and branch='Yashano' and edate = CURDATE() and estat='Complete' order by edate desc;");
                }
                while($row=$res->fetch_array()){                                       
                    ?>
                ...
                <tr style="text-align: center;">
                    ...
                    <tr>
                        ...
                        if($_SESSION['branch'] == Daet) {
                            $paidin = mysqli_num_rows( $MySQLiconn -> query("select eid as id,transno as tno,created_on as co,empname as ename,amountin as paid from employees_credit where transno not in (select epcreditin4 from tbepcredit1_v3) and not amountin='0' and branch='Daet' and edate = CURDATE() and estat='Complete' order by edate desc;"));
                        }elseif($_SESSION['branch'] == Magsaysay) {
                            ...
                            $paidin = mysqli_num_rows( $MySQLiconn -> query("select eid as id,transno as tno,created_on as co,empname as ename,amountin as paid from employees_credit where transno not in (select epcreditin4 from tbepcredit1_v3) and not amountin='0' and branch='Yashano' and edate = CURDATE() and estat='Complete' order by edate desc;"));
                        }
...
<?php } elseif (isset($_GET['rid'])) { ?>
  <table class="table table-bordered" id="dynamic_field_epcreditout">
    ...
    if($_GET['rid'] !=""){
        ...
        <?php
        if($_SESSION['branch'] == All) {
            $res = $MySQLiconn->query("select eid as id,transno as tno,created_on as co,empname as ename,amountout as credit from employees_credit where transno not in (select epcreditout4 from tbepcredit2_v3) and not amountout='0' and branch='$rf2' and edate = CURDATE() and estat='Complete' order by edate desc;");
        }elseif($_SESSION['branch'] == Daet) {
            $res = $MySQLiconn->query("select eid as id,transno as tno,created_on as co,empname as ename,amountout as credit from employees_credit where transno not in (select epcreditout4 from tbepcredit2_v3) and not amountout='0' and branch='Daet' and edate = CURDATE() and estat='Complete' order by edate desc;");
        }elseif($_SESSION['branch'] == Magsaysay) {
            ...
            $res = $MySQLiconn->query("select eid as id,transno as tno,created_on as co,empname as ename,amountout as credit from employees_credit where transno not in (select epcreditout4 from tbepcredit2_v3) and not amountout='0' and branch='Yashano' and edate = CURDATE() and estat='Complete' order by edate desc;");
        }
        while($row=$res->fetch_array()){
            ?>
            <?php if($_SESSION['access'] == Administrator || $_SESSION['access'] == Manager || $_SESSION['access'] == BranchControl) { ?>
