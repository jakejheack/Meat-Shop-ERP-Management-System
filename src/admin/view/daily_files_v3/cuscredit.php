                    ...
                    if($_GET['rid'] !=""){
                        ...
                        if ($result_product->num_rows > 0) {
                            ...
                            if($_SESSION['branch'] == All) {
                                $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1_v3) and not amountin='0' and branch='$rf2' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                                ...
                                $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1_v3) and not amountin='0' and branch='Magsaysay' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                            }elseif($_SESSION['branch'] == Yashano) {
                                $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1_v3) and not amountin='0' and branch='Yashano' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                            }
                            while($row=$res->fetch_array()){                                       
                                ?>
                            ...
                            <tr style="text-align: center;">
                                ...
                                <tr>
                                    ...
                                    if($_SESSION['branch'] == Daet) {
                                        ...
                                        $paidin = mysqli_num_rows( $MySQLiconn -> query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1_v3) and not amountin='0' and branch='Magsaysay' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;"));
                                    }elseif($_SESSION['branch'] == Yashano) {
                                        $paidin = mysqli_num_rows( $MySQLiconn -> query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1_v3) and not amountin='0' and branch='Yashano' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;"));
                                    }
                    ...
                    <?php } ?>
                            ...
                            if($_GET['rid'] !=""){
                                ...
                                if ($result_product->num_rows > 0) {
                                    ...
                                    <?php
                                    if($_SESSION['branch'] == All) {
                                        $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2_v3) and not amountout='0' and branch='$rf2' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                                    }elseif($_SESSION['branch'] == Daet) {
                                        ...
                                        $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2_v3) and not amountout='0' and branch='Magsaysay' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                                    }elseif($_SESSION['branch'] == Yashano) {
                                        $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2_v3) and not amountout='0' and branch='Yashano' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                                    }
                                    while($row=$res->fetch_array()){
                                        ?>
                                        <?php if($_SESSION['access'] == Administrator || $_SESSION['access'] == Manager || $_SESSION['access'] == BranchControl) { ?>
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            if($_SESSION['branch'] == Daet) {
                                                ...
                                                $creditout = mysqli_num_rows( $MySQLiconn -> query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2_v3) and not amountout='0' and branch='Magsaysay' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;"));
                                            }elseif($_SESSION['branch'] == Yashano) {
                                                $creditout = mysqli_num_rows( $MySQLiconn -> query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2_v3) and not amountout='0' and branch='Yashano' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;"));
                                            }
