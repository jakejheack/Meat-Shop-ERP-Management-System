...
<div class="row">
    ...
    <?php if(isset($_GET['view'])) { ?>
        <div class="form-group col-lg-8">
            <a href="../view/dl_dr2_v3?path=../admin/view/uploads/dailyRecords/<?php echo $getROW['imageText'];?>" target="_blank"><label style="margin-top:7px;margin-left:px;"><i class="mdi mdi-cloud-download-outline"></i>&ensp;Download File</label></a>
        </div>
