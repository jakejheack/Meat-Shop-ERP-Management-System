								...
								<div class="row">
									<div class="col-12" style="zoom:90%;">
												...
												<div class="card-body">
													...
													<div class="card-body">
														...
														<?php if ($setchicktab1 == '1') { ?> 
															<?php include 'daily_files_v3/chick_magsaysay.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setcuscredittab1 == '1') { ?> 
															<?php include 'daily_files_v3/cuscredit_magsaysay.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setempcredittab1 == '1') { ?> 
															<?php include 'daily_files_v3/empcredit_magsaysay.php';?>
														<?php } else { ?>
														<?php } ?> 
										...
										<div class="form-group mt-3" style="position:relative; text-align: right;padding-right: 30px;">
											<?php if(isset($_GET['view'])){?>
												<a href="fl_dailyrecords_v3.php" id="btnPrint" class="btn btn-dark waves-effect waves-light"><i class="mdi mdi-keyboard-backspace mr-2"></i> Back </a>
											<?php }elseif(isset($_GET['rid'])) { ?> 
