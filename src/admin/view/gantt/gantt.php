...
<head>
  ...
  <meta content="LEHMANN MEAT SHOP" name="description" />
...
<div class="__template__" type="GANTBUTTONS">
  ...
  <div class="ganttButtonBar noprint">
    <div class="buttons">
      <a><img src="../assets/images/logo_name.png" alt="Lehmann" align="absmiddle" style="max-width: 136px; padding-right: 15px"></a>
    ...
    <span class="ganttButtonSeparator"></span>
      <a href="../hr_scheduler" style="font-weight: 600;font-size: 15px;text-decoration: none;" text-align: right;"> BACK TO HOME </a>
      &nbsp; &nbsp; &nbsp; &nbsp;
    </div>

    <div>
      <button onclick="saveGanttOnServer();" class="button first big requireWrite" style="background-color: #34c38f" title="Save">Save</button>
      <input type="file" name="load-file" id="load-file">
      <label for="load-file">Load</label>&nbsp; &nbsp;
      <button onclick='newProject();' class='button requireWrite newproject' style="background-color: #74788d">Clear Project</button>
