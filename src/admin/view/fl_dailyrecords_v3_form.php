									...
									<div class="col-12" style="zoom:90%;">
												...
												<div class="card-body">
													...
													<div class="card-body">
														...
														<?php if ($setchicktab1 == '1') { ?> 
															<?php include 'daily_files_v3/chick.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setcuscredittab1 == '1') { ?> 
															<?php include 'daily_files_v3/cuscredit.php';?>
														<?php } else { ?>
														<?php } ?> 

														<?php if ($setempcredittab1 == '1') { ?> 
															<?php include 'daily_files_v3/empcredit.php';?>
														<?php } else { ?>
														<?php } ?> 
										...
										<div class="form-group mt-3" style="position:relative; text-align: right;padding-right: 30px;">
											...
											<?php }elseif(isset($_GET['rid'])) { ?> 
												...
												<a href="fl_dailyrecords_v3.php" class="btn btn-dark" style="color:white"><i class="mdi mdi-keyboard-backspace font-16 mr-1"></i> Back </a>
											<?php } else { ?>
												...
												<a href="fl_dailyrecords_v3.php" class="btn btn-dark waves-effect waves-light" style="color:white"><i class="mdi mdi-keyboard-backspace mr-2"></i> Back </a>
											<?php } ?> 
										</div>
										<div class="mt-4">
										</div>
