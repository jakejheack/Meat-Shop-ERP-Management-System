    ...
    <div class="container">
        ...
        <?php } elseif (isset($_GET['rid'])) { ?>
          <table class="table table-bordered" id="dynamic_field_cuscreditin">
            <b>#IN</b>&nbsp;<i>(This function was done in customer's payment <a href="cus_customers_payment" target="_blank">CUSTOMER'S CREDIT</a> and auto-generated here.)</i>
            <br><br>
        ...
        <?php } elseif (isset($_GET['rid'])) { ?>
          <table class="table table-bordered" id="dynamic_field_cuscreditout">
            <b>#OUT</b>&nbsp;<i>(This function was done in customer's payment <a href="cus_customers_payment" target="_blank">CUSTOMER'S CREDIT</a> and auto-generated here.)</i>
            <br><br>
            <tr style="text-align: center;">
                <td>Date</td>
                <td>Trans No.</td>
