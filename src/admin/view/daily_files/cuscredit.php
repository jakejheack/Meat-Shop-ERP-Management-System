        ...
        <div class="table-responsive mt-2">
            <?php if(isset($_GET['view'])) { ?>
             <table class="table table-striped" id="dynamic_field_cuscreditin" style="width: 100%;text-align:center;">
                 ...
                 <?php
                 $res = $MySQLiconn->query("SELECT * FROM tbcuscredit1 WHERE tb1_id=".$_GET['view']);
        ...
        <?php } elseif (isset($_GET['rid'])) { ?>
          <table class="table table-bordered" id="dynamic_field_cuscreditin">
            ...
            <?php } ?>
                    ...
                    <?php
                    if($_GET['rid'] !=""){
                        $product = "SELECT * FROM tbcuscredit1 WHERE NOT cuscreditin1=' ' and NOT cuscreditin2=' ' and NOT cuscreditin4=' ' and tb1_id='".$_GET['rid']."'";
                        ...
                        if ($result_product->num_rows > 0) {
                            ...
                            if($_SESSION['branch'] == All) {
                                $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1) and not amountin='0' and branch='$rf2' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                            }elseif($_SESSION['branch'] == Daet) {
                                $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1) and not amountin='0' and branch='Daet' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                            }elseif($_SESSION['branch'] == Magsaysay) {
                                $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1) and not amountin='0' and branch='Magsaysay' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                            }elseif($_SESSION['branch'] == Yashano) {
                                $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1) and not amountin='0' and branch='Yashano' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                            }
                            while($row=$res->fetch_array()){                                       
                                ?>
                                ...
                                <tr class="bg-soft-success">
                                    ...
                                    <td class="col-5">
                                        <input type="text" name="cuscreditin1[]" placeholder="Customer Name" class="form-control" value="<?php echo ucwords(strtolower($row['cname'])); ?>" readonly/>
                                    </td>
                                    <td class="col-3">
                    ...
                    <?php } else { ?>
                        <table class="table table-bordered" id="dynamic_field_cuscreditin">
                            ...
                            <tr style="text-align: center;">
                                ...
                                <tr>
                                    <?php
                                    if($_SESSION['branch'] == Daet) {
                                        $paidin = mysqli_num_rows( $MySQLiconn -> query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1) and not amountin='0' and branch='Daet' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;"));
                                    }elseif($_SESSION['branch'] == Magsaysay) {
                                        $paidin = mysqli_num_rows( $MySQLiconn -> query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1) and not amountin='0' and branch='Magsaysay' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;"));
                                    }elseif($_SESSION['branch'] == Yashano) {
                                        $paidin = mysqli_num_rows( $MySQLiconn -> query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountin as paid from customers_status where transno not in (select cuscreditin4 from tbcuscredit1) and not amountin='0' and branch='Yashano' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;"));
                                    }
                    ...
                    <div class="table-responsive mt-2">
                       <?php if(isset($_GET['view'])) { ?>
                         ...
                         <table class="table table-striped" id="dynamic_field_cuscreditout" style="width: 100%;text-align:center;">
                          ...
                          <?php
                          $res = $MySQLiconn->query("SELECT * FROM tbcuscredit2 WHERE  tb1_id=".$_GET['view']);
                          while($row=$res->fetch_array()){                                       
                             ?>
                             <tr>
                ...
                <?php } elseif (isset($_GET['rid'])) { ?>
                  <table class="table table-bordered" id="dynamic_field_cuscreditout">
                    ...
                    <?php } ?>
                            ...
                            <?php
                            if($_GET['rid'] !=""){
                                $product = "SELECT * FROM tbcuscredit2 WHERE NOT cuscreditout1=' ' and NOT cuscreditout2=' ' and NOT cuscreditout4=' ' and tb1_id='".$_GET['rid']."'";
                                $result_product = mysqli_query($conn, $product);
                                if ($result_product->num_rows > 0) {
                                    $xy=1;
                                    while($row_product = $result_product->fetch_assoc())
                                    ...
                                    <?php
                                    if($_SESSION['branch'] == All) {
                                        $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2) and not amountout='0' and branch='$rf2' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                                    }elseif($_SESSION['branch'] == Daet) {
                                        $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2) and not amountout='0' and branch='Daet' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                                    }elseif($_SESSION['branch'] == Magsaysay) {
                                        $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2) and not amountout='0' and branch='Magsaysay' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                                    }elseif($_SESSION['branch'] == Yashano) {
                                        $res = $MySQLiconn->query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2) and not amountout='0' and branch='Yashano' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;");
                                    }
                                    while($row=$res->fetch_array()){
                                        ?>
                                        <?php if($_SESSION['access'] == Administrator || $_SESSION['access'] == Manager || $_SESSION['access'] == BranchControl) { ?>
                                ...
                                <table class="table table-bordered" id="dynamic_field_cuscreditout">
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <tr>
                                            <?php
                                            if($_SESSION['branch'] == Daet) {
                                                $creditout = mysqli_num_rows( $MySQLiconn -> query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2) and not amountout='0' and branch='Daet' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;"));
                                            }elseif($_SESSION['branch'] == Magsaysay) {
                                                $creditout = mysqli_num_rows( $MySQLiconn -> query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2) and not amountout='0' and branch='Magsaysay' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;"));
                                            }elseif($_SESSION['branch'] == Yashano) {
                                                $creditout = mysqli_num_rows( $MySQLiconn -> query("select cusid as id,transno as tno,created_on as co,cusname as cname,amountout as credit from customers_status where transno not in (select cuscreditout4 from tbcuscredit2) and not amountout='0' and branch='Yashano' and cdate = CURDATE() and cpstat='Complete' order by cdate desc;"));
                                            }
