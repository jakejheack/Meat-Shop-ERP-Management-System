  ...
  <div class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="col-12">
          <div class="page-title-box d-flex align-items-center justify-content-between">
            <div class="page-title-left">
              <h4 class="mb-2">&ensp;Deductions</h4>
          ...
          <?php if($_SESSION['addbut'] == on){?>
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                <li><a type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="mdi mdi-account-multiple-minus mr-2 mr-2"></i>&nbsp;&nbsp;Add Deduction</a></li>&ensp;
              </ol>
            </div>
          <?php } ?>
      ...
      <?php if (isset($_SESSION['success_message']) && !empty($_SESSION['success_message'])) { ?>
        ...
        <?php include 'fl_deduction_modal.php'; ?>
      </div>
      <!-- end main content-->
    ...
    <script>
      ...
      function getRow(id){
        $.ajax({
          type: 'POST',
          url: '../controller/fl_deduction_row.php',
          data: {id:id},
          dataType: 'json',
