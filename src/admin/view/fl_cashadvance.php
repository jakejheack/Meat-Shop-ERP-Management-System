...
<?php include 'common/body.php'; ?>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-2">&ensp;Cash Advance</h4>
                                  ...
                                  <?php if($_SESSION['addbut'] == on){?>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li><a type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="mdi mdi-cash-plus mr-2 mr-2"></i>&nbsp;&nbsp;Add Cash Advance</a></li>&ensp;
                                        </ol>
                                    </div>
                                  <?php } ?>
                                    ...
                                    <div class="card-body">
                                        <table id="example" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="capitalize"><?php echo $row['firstname'].' '.$row['lastname'].' '.$row['suffix']; ?></td>
                                                ...
                                                <td style="width:1%;text-align: center;">
                                                    <div class="action-btn">
                                                      <?php if($_SESSION['editbut'] == on){?>
                                                        <a data-id="<?php echo $row['caid']; ?>" class="text-info ml-2 edit" title="edit"><i class="mdi mdi-pencil-box-outline" style="font-size:17px"></i></a>
                                                      <?php } ?>
                                                      <?php if($_SESSION['deletebut'] == on){?>
                                                        <a data-id="<?php echo $row['caid']; ?>" class="text-dark ml-2 delete" title="delete"><i class="mdi mdi-delete-variant" style="font-size:17px"></i></a>
                                                      <?php } ?>
                                                    </div>
                                                </td>
                                              <?php } ?>
           ...
           <?php include 'fl_cashadvance_modal.php'; ?>
        </div>
        <!-- end main content-->
    ...
    <script>
        ...
        function getRow(id){
          $.ajax({
            type: 'POST',
            url: '../controller/fl_cashadvance_row.php',
            data: {id:id},
            dataType: 'json',
