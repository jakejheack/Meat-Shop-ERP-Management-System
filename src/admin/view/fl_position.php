 ...
 <div id="layout-wrapper">
  ...
  <div class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="col-12">
          <div class="page-title-box d-flex align-items-center justify-content-between">
            <div class="page-title-left">
              <h4 class="mb-2">&ensp;Position Salary</h4>
              <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="dashboard1">&ensp;&nbsp;Home</a></li>
                <li class="breadcrumb-item active">Position Salary</li>
              </ol>
            </div>
            ...
            <?php if($_SESSION['addbut'] == on){?>
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  <li><a type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="mdi mdi-account-tie mr-2 mr-2"></i>&nbsp;&nbsp;Add Salary</a></li>&ensp;
                </ol>
              </div>
            <?php } ?>
                  ...
                  <table id="example" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                      ...
                      while($row = $query->fetch_assoc()){                                       
                        ?>
                        <tr>
                          <td class="capitalize"><?php echo $row['description']; ?></td>
      ...
      <?php include 'fl_position_modal.php'; ?>
    </div>
    <!-- end main content-->
