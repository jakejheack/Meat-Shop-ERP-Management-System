                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-2">&ensp;Credit Card In</h4>
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="dashboard1">&ensp;&nbsp;Home</a></li>
                                            <li class="breadcrumb-item active">Records</li>
                                            <li class="breadcrumb-item active">Credit Card In</li>
                                        </ol>
                                    </div>
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        &ensp;&ensp;
                                        <li><a href="fl_ovcrecard_in" class="btn btn-success waves-effect waves-light">&ensp;In&ensp;</a></li>&ensp;
                                        <li><a href="fl_ovcrecard_out" class="btn btn-danger waves-effect waves-light"> Out </a></li>&ensp;
                                    </ol>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <?php
                                                $i = 1;
                                                $format = "M d Y";
                                                $res = $MySQLiconn->query("SELECT * FROM tb1 JOIN tbcrcard1 ON tbcrcard1.tb1_id = tb1.id WHERE crcardin2 NOT IN (' ')");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo ucwords(strtolower($row['crcardin1'])); ?></td>
                                                <td>₱ <?php echo number_format($row['crcardin2'],2); ?></td>
                                            </tr>
                                            <?php
                                            } 
                                            ?>
                                            <?php
                                                $format = "M d Y";
                                                $res = $MySQLiconn->query("SELECT * FROM tb1 JOIN tbcrcard1 ON tbcrcard1.tb1_id = tb1.id WHERE crcardin4 NOT IN (' ')");
                                                while($row=$res->fetch_array()){                                       
                                            ?>
                                            <tr>
                                                <td style="width:1%;"><?php echo $i; $i++;?></td>
                                                <td style="width:5%;"><?php echo date_format(date_create($row['f1']), $format); ?></td>
                                                <td><?php echo ucwords(strtolower($row['f2'])); ?></td>
                                                <td><?php echo ucwords(strtolower($row['crcardin3'])); ?></td>
                                                <td>₱ <?php echo number_format($row['crcardin4'],2); ?>
