                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-2">&ensp;Checks Out</h4>
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="dashboard1">&ensp;&nbsp;Home</a></li>
                                            <li class="breadcrumb-item active">Records</li>
                                            <li class="breadcrumb-item active">Checks Out</li>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <th>Name</th>
                                                <th style="width:5%;">Amount Out</th>   
                                            </tr>
                                            </thead>
                                            <tbody>
                                             <?php
                                                $i = 1;
                                                $format = "M d Y";
                                                $res = $MySQLiconn->query("SELECT * FROM tb1 JOIN tbchecks2 ON tbchecks2.tb1_id = tb1.id WHERE checksout5 NOT IN (' ')");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo ucwords(strtolower($row['checksout1'])); ?></td>
                                                <td><?php echo mb_strtoupper(strtolower($row['checksout2'])); ?></td>
                                                <td><?php echo date('M-d-Y', strtotime($row['checksout3'])); ?></td>
                                                <td><?php echo ucwords(strtolower($row['checksout4'])); ?></td>
                                                <td>₱ <?php echo number_format($row['checksout5'],2); ?></td>
                                            </tr>
                                            <?php
                                            } 
                                            ?>
