                ...
                <div class="col-12">
                    ...
                    <?php if($_SESSION['addbut'] == on){?>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li><a href="pro_distcalendar_form" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-calendar-clock mr-2"></i> Add Event </a></li>&ensp;
                            </ol>
                        </div>
                    <?php } ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            type="text" name="sd_calendarTitle" id="event-title" required value="" readonly />
                                                            <div class="invalid-feedback">Please provide a valid event name</div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Start Date</label>
                                                            <input class="form-control" placeholder="Insert Event Name"
                                                            type="text" name="sd_calendarTitle" id="event-start" required value="" readonly/>
                                                            <div class="invalid-feedback">Please provide a valid event name</div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">End Date</label>
                                                            <input class="form-control" placeholder="Insert Event Name"
                                                            type="text" name="sd_calendarTitle" id="event-end" required value="" readony/>
                                                            <div class="invalid-feedback">Please provide a valid event name</div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        !function($) {
            ...
            while($row=$res->fetch_array()){                                       
                ?>
                {
                    title: '<?php echo $row['sd_calendarTitle']; ?>',
                    start: '<?php echo $row['sd_calendarSdate']; ?>',
                    end: '<?php echo $row['sd_calendarEdate']; ?>',
                    className: '<?php echo $row['sd_calendarColor']; ?>'
                },
