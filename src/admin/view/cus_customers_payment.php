        ...
        <div class="col-12">
          <div class="page-title-box d-flex align-items-center justify-content-between">
            <div class="page-title-left">
              <h4 class="mb-2">&ensp;Customers Credit Records</h4>
              <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="dashboard1">&ensp;&nbsp;Home</a></li>
                <li class="breadcrumb-item"><a href="cus_customers_payment">Credit Overview</a></li>
                <li class="breadcrumb-item active">Credit Records</li>
              </ol>
            </div>
                  ...
                  <li>
                    <div class="btn-group">
                      <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        &ensp;Add Transaction&ensp;<i class="mdi mdi-chevron-down"></i>
                      </button>
                      <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Credit</a>
                        <a class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">Paid</a>
                      </div>
                    </div>
                  </li>&ensp;
                  <li><a href="cus_customers_sort" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-filter-outline mr-2"></i> Filter</a></li>&ensp;
                <li><a href="cus_customers_status" class="btn btn-dark waves-effect waves-light"><i class="mdi mdi-keyboard-backspace mr-2"></i> Overview</a></li>
              </ol>
            </div>
          <?php } ?>
        </div>
