...
<?php include '../controller/ex_loc_leave.php'; ?>
<!doctype html>
<html lang="en">
                   ...
                   <!-- start page title -->
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-2">&ensp;Leave Description</h4>
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="dashboard1">&ensp;&nbsp;Home</a></li>
                                            <li class="breadcrumb-item"><a href="ex_localization">Localization</a></li>
                                            <li class="breadcrumb-item active">Leave Description</li>
                                        </ol>
                                    </div>
                    ...
                    <div class="card card-body">
                        <div class="row" style="text-align:right">
                                ...
                                <div class="col-md-7">     
                                        <input type="text" name="ex_leave" class="form-control" value="<?php if(isset($_GET['edit'])) echo $getROW['ex_leave'];?>" placeholder="Add Leave Description" autocomplete="off" required >
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="example" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                            <tr>
                                                <th width="90%">Leave Description</th>
                                                <th>Status</th>
                                            ...
                                            <tbody>
                                            <?php $res = $MySQLiconn->query("SELECT * FROM leave_description");
                                                    while($row=$res->fetch_array()) { ?>
                                            <tr>
                                                <td><?php echo utf8_encode(ucwords(strtolower($row['ex_leave']))); ?></td>
                                            ...
                                            <?php if($_SESSION['editbut'] == on || $_SESSION['deletebut'] == on){?>
                                                <td>
                                                    ...
                                                    <?php if($_SESSION['editbut'] == on){?>
                                                        <a href="?edit=<?php echo $row['ex_leaveID']; ?>" class="text-info" title="edit"><i class="mdi mdi-pencil-box-outline" style="font-size:17px"></i></a>
                                                    <?php } ?>
                                                    <?php if($_SESSION['deletebut'] == on){?>
                                                        <a href="?del=<?php echo $row['ex_leaveID']; ?>" onclick="return confirm('sure to delete !'); " class="text-dark ml-2" title="delete"><i class="mdi mdi-delete-variant" style="font-size:17px"></i></a>
                                                    <?php } ?>
                                                    </div>
                                                </td>
                                            <?php } ?>
